  ...
  Future<Usuario?> login(String username, String password) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        int? idUsuario = jsonAuth["permisos"]?["id_usuario"] as int?;
        ...
        // Login exitoso
        return Usuario(idUsuario: idUsuario,nombreUsuario: username, claveHash: password, tipoUsuario: tipoUsuario, activo: activoUsuario);
