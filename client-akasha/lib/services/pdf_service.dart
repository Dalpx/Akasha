...
enum TipoMovimientoFiltro { todos, entrada, salida }

class PdfService {
  // ===========================================================================
  // . REPORTE INDIVIDUAL (Factura de Compra)
  // ===========================================================================
  Future<Uint8List> generarFacturaVenta(
    Venta venta,
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                ...
                children: [
                  pw.Text(
                    venta.numeroComprobante ?? 'Sin Ref',
                    style: pw.TextStyle(
                      fontSize: 24,
                ...
                children: [
                  ...
                  pw.Expanded(
                    child: pw.Column(
                      crossAxisAlignment: pw.CrossAxisAlignment.start,
                      children: [
                        _buildPdfField("Fecha:", venta.fecha.toString()),
                        _buildPdfField("ID Venta:", "${venta.idVenta}"),
                      ],
                    ),
                  ),
                ],
  ...
  // ===========================================================================
  Future<Uint8List> generarFacturaCompra(
    Compra compra,
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Text(
                totalProductosAgotados.toString(),
                style: pw.TextStyle(
                  fontWeight: pw.FontWeight.bold,
                  fontSize: 16,
                  color: odooAlert,
  ...
  Future<Uint8List> generarReporteStockPorUbicacion({
    ...
    for (var d in datos) {
      ...
      stockPorAlmacen.update(
        ubicacion,
        (existingCount) => existingCount + cantidad,
        ifAbsent: () => cantidad,
      );
    }
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              pw.Container(
                width:
                    250, // Ampliamos un poco el contenedor para las etiquetas de almacén
                child: pw.Column(
  ...
  Future<Uint8List> generarReporteKardex({
    ...
    if (filtroTipo != TipoMovimientoFiltro.todos) {
      tituloKardex =
          "KARDEX - Movimientos de ${filtroTipo == TipoMovimientoFiltro.entrada ? 'ENTRADA' : 'SALIDA'}";
    }
      ...
      pw.MultiPage(
        ...
        build: (context) => [
          pw.Table.fromTextArray(
            ...
            data: datos.map((item) {
              final double cantidad = (item['cantidad'] as num? ?? 0)
                  .toDouble();

              final ref = item['descripcion'] ?? item['id_movimiento'];
              final producto = item['nombre_producto'];
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Text(
                currencyFormat.format(valorTotalInventario),
                style: pw.TextStyle(
                  fontWeight: pw.FontWeight.bold,
                  fontSize: 16,
                  color: odooTeal,
  ...
  Future<Uint8List> generarReporteAABC({
    ...
    final pdf = pw.Document();
    final odooPurple = PdfColor.fromInt(
      0xFF714B67,
    ); // Color para el reporte ABC
    final currencyFormat = NumberFormat.currency(
      locale: 'es_VE',
      symbol: '\$',
      decimalDigits: 2,
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        header: (context) => pw.Column(
          ...
          children: [
            pw.Text(
              "CLASIFICACIÓN ABC DE INVENTARIO (PARETO)",
              style: pw.TextStyle(
                fontSize: 18,
                fontWeight: pw.FontWeight.bold,
                color: odooPurple,
            ...
            pw.Text(
              "Fecha de Clasificación: ${DateFormat('dd/MM/yyyy').format(DateTime.now())}",
              style: const pw.TextStyle(fontSize: 10, color: PdfColors.grey),
            ),
            pw.Divider(),
            pw.SizedBox(height: 10),
        ...
        build: (context) => [
          ...
          pw.Row(
            ...
            children: [
              pw.Container(
                width:
                    350, // Más ancho para acomodar la información de porcentaje
                child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.end,
                  children: [
                    pw.Text(
                    ...
                    ...['A', 'B', 'C'].map((clase) {
                      ...
                      final pctProductos = totalProductos > 0
                          ? (conteoClase / totalProductos) * 100
                          : 0.0;
                      final pctVCA = vcaTotal > 0
                          ? (vcaClase / vcaTotal) * 100
                          : 0.0;
                      ...
                      return _buildPdfAABCSummaryRow(
                        ...
                        color,
                        isSummary:
                            true, // Usamos el helper para filas de resumen
                      );
                    }).toList(),
  ...
  Future<Uint8List> generarReporteKPI(
  ...
  pw.Widget _buildPdfAABCSummaryRow(
    String label,
    String pctProd,
    String pctVCA,
    String value,
  ...
  pw.Widget _buildKardexSummaryRow(
    String label,
    double amount,
    NumberFormat format,
    PdfColor color, {
