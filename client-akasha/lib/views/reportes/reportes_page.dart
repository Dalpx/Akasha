  ...
  List<Map<String, dynamic>> _mapearReporteAABCParaVista(List<Map<String, dynamic>> reporteAABC) {
    ...
    return reporteAABC.map((item) {
      ...
      return {
        // 'ref': SKU o ID
        'ref': item['sku'] ?? 'N/A', 
        // 'fecha': Nombre del Producto (se usa como segunda línea en la vista)
        'fecha': item['nombre'] ?? 'Producto Desconocido', 
        // 'entidad': La clase ABC y una descripción
        'entidad': 'Clase $clase', 
        // 'total': El VCA calculado (Valor monetario para este reporte)
        'total': vca,
        'timestamp': null, 
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(children: [
                    ...
                    const SizedBox(width: 16),
                    // Usamos el KPI para mostrar el Valor AABC (VCA Total)
